...
> A day-by-day record of my machine learning and AI learning journey, shared openly to encourage others.
>
...
## April 17, 2026 - Google DeepMind Meetup: How It All Started, Cactus AI & Unsloth

I attended a Google DeepMind meetup called Gemma 4 SF Edition. There I met **Henry Ndubuaku**, a YC founder from an AI company called **Cactus AI**. It's a YC S25 company that helps distill open source models for on-the-edge computation. Henry published 7 years of his studies and research on ML and AI learning, the link is in the resources below.

I also got to learn about the **Google DeepMind Gemma 4** model, which is multimodal and can be run locally on the edge. Gemma 4 works across voice, image and text, which makes it pretty impressive for an open model you can run on your own device.

On this evening, I also got to learn about **Unsloth** and got to know the founders, **Daniel Han** and his brother **Michael Han**. It became clear to me that Unsloth is a tool that helps you train open source models. They are YC S24.

Henry is the person that encouraged me to start learning about machine learning, because there's all the content that we need online to learn it. And so it's just about putting in the effort, and especially since I have a background in computer science and mathematics, I have the foundation to put myself in, lock in, and learn it.

### People

- **Henry Ndubuaku**, Founder of Cactus AI · [LinkedIn](https://www.linkedin.com/in/henry-ndubuaku-7b6350b8/)
- **Daniel Han**, Co-founder of Unsloth AI · [LinkedIn](https://www.linkedin.com/in/danielhanchen)
- **Michael Han**, Co-founder of Unsloth AI · [LinkedIn](https://www.linkedin.com/in/michaelhan3/)

### Companies & Tools

- **Cactus AI** (YC S25): Henry's company. They run AI models directly on smartphones and edge devices, no cloud needed, low latency, full privacy · [cactuscompute.com](https://cactuscompute.com)
- **Unsloth AI** (YC S24): Daniel and Michael's tool. It lets you fine-tune your own open source LLM on a regular laptop, no expensive GPU servers or cloud bills needed · [unsloth.ai](https://unsloth.ai)
- **Gemma 4**: Google DeepMind's open multimodal model. Runs locally on the edge and works across voice, image and text · [deepmind.google](https://deepmind.google/models/gemma/)

### Resources

- [Henry Ndubuaku's Maths, CS & AI Compendium](https://henryndubuaku.github.io/maths-cs-ai-compendium/) - 7 years of curated ML/AI/math/CS learning
...
I also decided to share everything to encourage and help others, that if we put in time and effort we can learn anything.

### People

- **Samarth Shukla**, ML Researcher at Magic AI · [LinkedIn](https://www.linkedin.com/in/samarth189)
...
- **Naaman Newbold**, VP of Engineering at Synthflow · [LinkedIn](https://www.linkedin.com/in/naaman)

### Companies & Tools

- **Synthflow**: Enterprise voice AI platform that builds and deploys AI phone agents that can handle calls, book appointments and qualify leads at scale · [synthflow.ai](https://synthflow.ai)
...
What I love about this book is that it walks through every single piece from scratch. No black boxes. You build it yourself and you understand why it works. That's exactly the approach I need.
...
The article breaks the AI stack into three layers: **application development**, **model development**, and **infrastructure**. The part I found most useful is how it explains the difference between AI engineering and ML engineering, something I didn't fully understand before.
...
- **Chip Huyen**, Author of AI Engineering · [LinkedIn](https://www.linkedin.com/in/chiphuyen/)
- **Gergely Orosz**, Author of The Pragmatic Engineer newsletter · [LinkedIn](https://nl.linkedin.com/in/gergelyorosz)
...
## May 2, 2026 - Found on LinkedIn: 8-Session Fine-Tuning Curriculum by Miguel Otero Pedrido, Powered by Unsloth

Scrolling LinkedIn today and came across a post from **Miguel Otero Pedrido** about an 8-session training curriculum he built, going all the way from pre-training to production, powered by **Unsloth AI**. I immediately went to read the full blog post and I'm intending to go through the whole thing.

Miguel is an ML Engineer and the founder of **The Neural Maze**, a newsletter and learning hub where he explains ML concepts step by step with code, articles, and video tutorials. The course is called **Finetuning Sessions** and it's one of the most practical curricula I've come across since starting this journey.

The course runs over 8 weeks, theory on Wednesday, hands-on code on Friday, live discussion on Sunday, and covers 8 sessions with 24 deliverables in total. The tech stack is Unsloth, Comet, and HuggingFace. Here's what the curriculum covers:

1. **Foundations**: What pretraining actually means, the Transformer architecture, and the full LLM training pipeline from pretraining to fine-tuning to alignment
2. **QLoRA**: How to fine-tune a frontier model on a single consumer GPU using 4-bit quantization
3. **Supervised Fine-Tuning (SFT)**: Why it exists, how loss masking works, chat templates, instruction formats, and dataset creation
4. **LoRA**: Why low-rank adaptation works, where adapters fit inside the Transformer, and the hyperparameters that matter, rank, alpha, target modules
5. **Alignment**: The RLHF landscape, reward models, PPO, DPO, and KTO
6-8. **Production**: Getting models out of notebooks and into the real world

What I really like about this is that it goes from first principles all the way to deployment with no gaps. And since it's built on Unsloth you can run the whole thing on a regular laptop, no expensive cloud setup needed.

### People

- **Miguel Otero Pedrido**, ML Engineer and Founder of The Neural Maze · [LinkedIn](https://www.linkedin.com/in/migueloteropedrido/)

### Companies & Tools

- **The Neural Maze**: Miguel's newsletter and learning hub for ML engineers · [theneuralmaze.substack.com](https://theneuralmaze.substack.com)
- **Unsloth AI** (YC S24): Powers the entire course · [unsloth.ai](https://unsloth.ai)
- **HuggingFace**: Model hub used throughout the curriculum for loading and sharing models · [huggingface.co](https://huggingface.co)
